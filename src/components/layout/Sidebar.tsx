...
import { Link2, Settings, LogOut, LayoutDashboard, Shield, Key, UserCog, HelpCircle, Menu, Activity, Users, ShieldAlert, Flag, Eraser, Ban } from "lucide-react";
...
const adminNavItems = [
  ...
  { path: "/ban", label: "Ban Management", icon: Ban },
