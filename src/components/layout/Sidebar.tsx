...
import { Link2, Settings, LogOut, LayoutDashboard, Shield, Key, UserCog, HelpCircle, Menu, Activity, Users, ShieldAlert, Flag, Trash2 } from "lucide-react";
...
const adminNavItems = [
  ...
  { path: "/eliminar", label: "Delete Clients", icon: Trash2 },
